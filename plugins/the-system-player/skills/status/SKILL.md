...
featured: 8
tagline: "Your level, XP, and streak."
---
...
4. **Report**: Level, Rank, Total XP and XP to next level, streak, any active debuffs (🟠 Hesitation / 🔴 Fading Gate / 🔔 Cooling Ally — pull from the pipeline if the player wants specifics; note that pre-contact quests never generate Hesitation or Fading Gate, so a quiet application is not a debuff), and achievement/badge count. Keep it to the numbers and a line of color, not a full re-explanation of the whole game system every time.
