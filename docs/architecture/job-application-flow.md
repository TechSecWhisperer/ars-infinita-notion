...
sequenceDiagram
    ...
    V->>V: gather: Status Window, Stat Sheet, Story Bank, JD, Appraisal, Gate Intel (confidential filtered — hard rule 4)
    V->>V: target market from quest location; layout preset chosen
